...
#
# Usage: fetch-model.sh [qwen3.5-0.8b | qwen3.5-4b | qwen3.5-9b]  (default: qwen3.5-4b)
#
...
#                   with `-model qwen3.5-4b` (high-memory layout).
...
case "$MODEL" in
  ...
  qwen3.5-9b|9b)
    ...
    ;;
  *)
    echo "unknown model '$MODEL' (expected qwen3.5-0.8b, qwen3.5-4b, or qwen3.5-9b)" >&2
    exit 1
    ;;
esac
