...
fn generate_builtin_rules() -> Vec<(&'static str, TokenStream)> {
    ...
    for property in UNICODE_PROPERTY_NAMES {
        ...
        builtins.push((property, quote! {
            ...
            fn #property_ident(state: ::alloc::boxed::Box<::pest::ParserState<Rule>>) -> ::pest::ParseResult<::alloc::boxed::Box<::pest::ParserState<Rule>>> {
                    ...
                    > {
                        mod rules {
                            pub mod hidden {
                                ...
                                #[inline]
                                #[allow(dead_code, non_snake_case, unused_variables)]
                                pub fn skip(state: ::alloc::boxed::Box<::pest::ParserState<Rule>>) -> ::pest::ParseResult<::alloc::boxed::Box<::pest::ParserState<Rule>>> {
                                    Ok(state)
                                }
                            }
                            ...
                            pub mod visible {
                                ...
                                #[inline]
                                #[allow(non_snake_case, unused_variables)]
                                pub fn a(state: ::alloc::boxed::Box<::pest::ParserState<Rule>>) -> ::pest::ParseResult<::alloc::boxed::Box<::pest::ParserState<Rule>>> {
                                    state.match_string("b")
                                }

                                #[inline]
                                #[allow(dead_code, non_snake_case, unused_variables)]
                                pub fn ANY(state: ::alloc::boxed::Box<::pest::ParserState<Rule>>) -> ::pest::ParseResult<::alloc::boxed::Box<::pest::ParserState<Rule>>> {
                                    state.skip(1)
                                }
                            }
