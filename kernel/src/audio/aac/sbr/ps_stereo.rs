...
use alloc::vec::Vec;
use alloc::vec;
use super::ps_data::{PsData, PsIndices};
use super::ps_hybrid::{HybridConfig, NUM_QMF_SLOTS};
use super::ps_map::{conjugate_flags, map_indices, parameter_map, MAP_20_TO_34, MAP_34_TO_20};
...
impl PsStereo {
    ...
    fn envelope_h(&mut self, ps: &PsData, idx: &PsIndices, e: usize) -> Result<Vec<H4>> {
        ...
        for b in 0..nb {
            ...
            let rho = *ICC_RHO.get(icc[b] as usize).ok_or("aac/sbr: ps data invalid")?;
