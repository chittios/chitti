...
InjecAgent~\cite{zhan2024injecagent} cannot be run here --- they are harnesses
over tool suites this system does not have (email clients, banking APIs, smart
devices) --- but their \emph{intent taxonomy} transfers, and the corpus is now
mapped against it: destroy user data, change persistent state, exfiltrate to an
