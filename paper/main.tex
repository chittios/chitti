...
License 2.0~\cite{chittios}. Every number in \S\ref{sec:eval} was taken at
commit \code{733ae9a} and is reproducible from a checkout without special
hardware: \code{cargo xtask test} runs the in-kernel unit suite under QEMU,
