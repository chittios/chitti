...
0\%}: 2 of 4 benign destructive steps still need a human, and both are the
warranted ones (a delete whose target came out of searched content, and an
...
Citation-constrained (\S\ref{sec:e3c}, proposed) & \textbf{0 / 13} & \textbf{2 / 11} & not built \\
